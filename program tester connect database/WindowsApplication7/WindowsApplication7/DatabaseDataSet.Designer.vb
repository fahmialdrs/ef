...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class Table1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddTable1Row(ByVal nim As String, ByVal nama As String, ByVal kelas As String) As Table1Row
            Dim rowTable1Row As Table1Row = CType(Me.NewRow,Table1Row)
            Dim columnValuesArray() As Object = New Object() {nim, nama, kelas}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindBynim(ByVal nim As String) As Table1Row
            Return CType(Me.Rows.Find(New Object() {nim}),Table1Row)
        End Function
    ...
    Partial Public Class Table1Row
        ...
        Public Property kelas() As String
            Get
                Try 
                    Return CType(Me(Me.tableTable1.kelasColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'kelas' in table 'Table1' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTable1.kelasColumn) = value
            End Set
        End Property
        ...
        Public Function IskelasNull() As Boolean
            Return Me.IsNull(Me.tableTable1.kelasColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetkelasNull()
            Me(Me.tableTable1.kelasColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DatabaseDataSetTableAdapters
    ...
    Partial Public Class Table1TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`nim` = ?) AND ((? = 1 AND `nama` IS NULL) OR (`nama"& _ 
                "` = ?)) AND ((? = 1 AND `kelas` IS NULL) OR (`kelas` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`nim`, `nama`, `kelas`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `nim` = ?, `nama` = ?, `kelas` = ? WHERE ((`nim` = ?) AND ((?"& _ 
                " = 1 AND `nama` IS NULL) OR (`nama` = ?)) AND ((? = 1 AND `kelas` IS NULL) OR (`"& _ 
                "kelas` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.WindowsApplication7.My.MySettings.Default.DatabaseConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT nim, nama, kelas FROM Table1"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_nim As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nim As String, ByVal nama As String, ByVal kelas As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal nim As String, ByVal nama As String, ByVal kelas As String, ByVal Original_nim As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
            If (nim Is Nothing) Then
                Throw New Global.System.ArgumentNullException("nim")
            Else
            ...
            If (Original_nim Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_nim")
            Else
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(Original_nim,String)
            End If
            If (Original_nama Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nama As String, ByVal kelas As String, ByVal Original_nim As String, ByVal Original_nama As String, ByVal Original_kelas As String) As Integer
            Return Me.Update(Original_nim, nama, kelas, Original_nim, Original_nama, Original_kelas)
        End Function
    End Class
